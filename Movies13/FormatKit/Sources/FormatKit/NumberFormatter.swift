...
public extension NumberFormatter {
	...
	func numberStyle(_ numberStyle: Style) -> Self {
	...
	func alwaysShowsDecimalSeparator(_ alwaysShowsDecimalSeparatoralwaysShowsDecimalSeparatoralwaysShowsDecimalSeparator: Bool) -> Self {
	...
	func paddingPosition(_ paddingPosition: PadPosition) -> Self {
		self.paddingPosition = paddingPosition
		return self
	}
	
	func roundingMode(_ roundingMode: RoundingMode) -> Self {
